...
5. Deploy the frontend from the same revision. Sign in with the owner magic link and confirm session count and lifetime totals against the pre-migration backup.
